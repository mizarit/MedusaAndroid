...
import app.medusa.nl.medusa.AndroidJS;
import app.medusa.nl.medusa.CustomWebViewClient;
import app.medusa.nl.medusa.GcmActivity;
import app.medusa.nl.medusa.SensorActivity;
...
public class Main extends GcmActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myAndroidJS = new app.medusa.nl.medusa.AndroidJS(getApplicationContext());
